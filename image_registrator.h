...
public:
    ...
    void SetParameters(double factor, int margin_h_,int margin_w_, double sigma_smoothing, double sigma_normalization,
...
private:
    ...
    int margin_h_ = 64;  // number of pixels at the edge. same as maximum pixels to correct.
    int margin_w_ = 32;  // number of pixels at the edge. same as maximum pixels to correct.
